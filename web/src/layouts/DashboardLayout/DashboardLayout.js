            ...
            <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
              <ul className="flex flex-col py-4 space-y-1">
                  ...
                  <>
                    ...
                    <>
                      <li onClick={toggleDropDown.bind(this, 'lab')}>
                        <Link to={routes.labWaiting({ lab: currentUser?.permissions?.labAssign })} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                ...
                <>
                  ...
                  {/* <li className="relative">
                    ...
                    {dropDownOpen == 'Certificate' && (
                      <ul className="relative left-0 z-10 py-2 mt-2 bg-gray-800 rounded-md shadow-lg">
                        ...
                        <li>
                          <Link
                            to={routes.birthCertificates({type:'Birth'})}
                            className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6"
                          >
                            <span className="inline-flex justify-center items-center ml-4">
                              <svg
                            ...
                            <span className="ml-2 text-sm tracking-wide truncate">View Birth Certificate</span>

                          </Link>
                        </li>
                        <li>
                          <Link
                            to={routes.birthCertificates({type:'Dead'})}
                            className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6"
                          >
                            <span className="inline-flex justify-center items-center ml-4">
                              <svg
                            ...
                            <span className="ml-2 text-sm tracking-wide truncate">View Dead Certificate</span>
                          ...
                          }
                          {
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Add Dosage</span>
                          ...
                          }
                          {
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Add Frequency</span>
                          ...
                          }
                          {
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Add Duration</span>
                          ...
                          }
                          {
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Add Lab</span>
                          ...
                          }
                          {
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Add Lab Price List</span>
...

                  {
                    ...
                    <>
                      <li onClick={toggleDropDown.bind(this, 'opd')}>
                        <Link to={routes.drWaiting({ id: currentUser.id })} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                          <span className="inline-flex justify-center items-center ml-4">
                            <BsPersonFillAdd />
                          </span>
                          <span className="ml-2 text-sm tracking-wide truncate">Waiting</span>
                  ...
                  {
                    currentUser.roles == 'pharmacy' &&
                    <>
                      <li onClick={toggleDropDown.bind(this, 'opd')}>
                        <Link to={routes.pharmacyWaiting()} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                          <span className="inline-flex justify-center items-center ml-4">
                            <BsPersonFillAdd />
                          </span>
                          <span className="ml-2 text-sm tracking-wide truncate">Waiting</span>
                  ...
                  <>
                    <li className="relative">
                      ...
                      >
                        ...
                        <span className="ml-2 text-sm tracking-wide truncate">Clinic Report</span>
                        <span className="hidden md:block px-2 py-0.5 ml-auto  font-medium tracking-wide text-xl rounded-full">
                          {
                          ...
                          }
                          {
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Sale Medicine (QR Code) </span>
                ...
                {
                  (currentUser.permissions?.pharmacy?.includes('SaleMedicines') || isAdmin) &&
                  <li onClick={toggleDropDown.bind(this, 'saleMedicines')}>
                  <Link to={routes.saleMedicines()} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
