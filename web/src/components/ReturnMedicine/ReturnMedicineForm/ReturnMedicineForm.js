...
import NewReturnMedicineTable from '../NewReturnMedicineTable/NewReturnMedicineTable'
...
const ReturnMedicineForm = (props) => {
  ...
  const onSubmit = (data) => {
    // props.onSave(data, props?.returnMedicine?.id)
  ...
  for (var i = 0; i < no_of_medicine; i++) {
    medicineRows.push(<NewReturnMedicineTable key={'sale_' + i} value={i}
...
export default ReturnMedicineForm
