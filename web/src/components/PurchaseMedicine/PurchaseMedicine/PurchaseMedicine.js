...
const PurchaseMedicine = ({ purchaseMedicine }) => {
  ...
  <div className="col-span-2">
    <h2 className="text-xl font-bold mb-4">PurchaseMedicine {purchaseMedicine.id} Detail</h2>
  </div>
    ...
    <table className="w-full border border-gray-200">
      <tbody>
        ...
        <tr>
          ...
          <td className="p-4">{purchaseMedicine.distributerId}</td>
        </tr>
        <tr>
      ...
      <tbody>
        {purchaseMedicine.medicine.map((item, index) => (
          <tr key={index}>
            ...
            <td className="p-4">{item.net_amount}</td>
          </tr>
        ))}
      </tbody>
    </table>
  ...
  <div>
    ...
    <p className="p-4">{purchaseMedicine.sgst}</p>
  </div>

  <div>
    <p className="text-lg font-bold">Cgst</p>
    <p className="p-4">{purchaseMedicine.cgst}</p>
  </div>
